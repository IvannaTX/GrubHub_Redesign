        ...
        <div id="icon-slider">
          ...
          <div id="slider">
            ...
            <div className="slider-card">
              <div className="slider-card-image">
                <img
                  src="./Images/png-transparent-shish-kebab-doner-kebab-barbecue-fast-food-vegetables-and-chicken-food-animals-chicken-thumbnail-removebg-preview.png"
                  width="80%"
                  height="120px"
                ></img>
              </div>
